...
android {
    ...
    // Don't build any native libs, WireGuard Go is supplied via the go-vpn-lib.
    // The code is commented out and not removed to make it easier to see and handle conflicts when updating.
//    externalNativeBuild {
//        cmake {
